...
export const PORTFOLIO_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      image: "/images/precision-heart.webp",
      imageType: "dashboard",
      featured: true,
    },
    {
  ...
  skills: [
    ...
    },
    {
      title: "Mobile",
      skills: [
        { name: "Android", icon: "Bot", highlight: true },
        { name: "iOS Development", icon: "Apple", highlight: true },
        { name: "React Native", icon: "Smartphone" },
        { name: "Expo", icon: "Box" },
        { name: "React Navigation", icon: "Layers" },
        { name: "NativeWind (Tailwind CSS)", icon: "Palette" },
        { name: "REST APIs", icon: "Globe" },
        { name: "Firebase", icon: "Flame" },
        { name: "Android Studio", icon: "Bot" },
      ],
    },
    {
      title: "Tools & DevOps",
